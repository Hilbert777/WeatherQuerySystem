...
- 支持设置置顶城市和默认城市，置顶城市优先显示，默认城市用于首页初始选中。
- 城市列表会显示预警角标，最近搜索城市可直接点击再次查看。
...
- “今日观察”下方提供“今日提醒”，汇总预警、出行、温度、穿衣和空气质量等实用判断。
- 页面显示天气更新时间和缓存提示，方便判断数据新鲜度。
...
- 拖拽左侧城市条目，可以调整城市顺序。
- 点击城市条目右侧的“↑”，可以把该城市设为置顶城市。
- 点击城市条目右侧的“★”，可以把该城市设为默认城市。
- 城市条目会显示当前预警状态；无生效预警时显示“无预警”，有预警时显示预警数量。
- 点击城市右侧删除按钮，可以删除城市。
- 删除后可点击撤销恢复。
- 最近搜索过的城市会显示在“最近搜索”区域，点击后可再次进入详情页。
- 在地图上点击城市图标，也可以进入城市详情页。
- 地图支持拖拽、滚轮缩放、放大、缩小和复位。
- 首页主导航栏处于普通页面流中，位于页面顶部，滚动页面时不会吸顶。
...
- 右侧“今日观察”下方会显示“今日提醒”，用于快速查看出行、预警、温度、穿衣和空气质量提示。
- 页面顶部和“今日观察”区域会显示更新时间；如果数据来自后端缓存，会显示缓存提示。
- 城市详情页顶部操作栏同样位于页面顶部，滚动页面时不固定、不吸顶。
